(function (e) {
    ...
    "0423": function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "Ê"‰æ°Á∑èÈ°ç„í©„í≥„Ø",
          mcap: "Ê"‰æ°Á∑èÈ°ç",
          "24h_volume": "24Ê"ÈÂèÂº"È´‹",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          powered_by: "Powered by %{name_start}%{name}%{name_end}",
          crypto_price_comparison: "‰ªÆÊí≥È¨aË≤®‰æ°Ê ºÊØËºí",
          crypto_market_cap_comparison: "‰ªÆÊí≥È¨aË≤®Ê"‰æ°Á∑èÈ°çÊØËºí",
        },
        ...
        coin_market_ticker_list_widget: {
          ...
          price: "‰æ°Ê º",
          volume: "ÂèÂº"È´‹",
          trust_score: "„í∆„í©„π„í∆„π„≥„¢",
          view_price_chart: "‰æ°Ê º„íÅ„í£„íº„í∆„Ë°®Á§∫",
          powered_by: "Powered by %{name_start}%{name}%{name_end}",
    ...
    "056c": function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "Á∏ΩÂ∏Â¨ºÊ}Âêç",
          mcap: "Á∏ΩÂ∏Â¨º",
          "24h_volume": "24 Â∞èÊ"‰∫§Ê‹È!è",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          powered_by: "Ê≠§ÊSçÂ9"Ê‹ØÁ± %{name_start}%{name}%{name_end} Êèê‰æ:",
          crypto_price_comparison: "Â` ÂØ Ë≤®Âπ£ÂRØÁ}!ÊØËºí",
          crypto_market_cap_comparison: "Â` ÂØ Ë≤®Âπ£Á∏ΩÂ∏Â¨ºÊØËºí",
        },
        coin_price_static_headline_widget: {
          powered_by: "Ê≠§ÊSçÂ9"Ê‹ØÁ± %{name_start}%{name}%{name_end} Êèê‰æ:",
        },
        coin_price_chart_widget: {
          "24h_high": "24 Â∞èÊ"È´‹Âíπ",
          "24h_low": "24 Â∞èÊ"‰Ω}Âíπ",
          view_price_chart: "View %{coin} Price Chart",
          powered_by: "Ê≠§ÊSçÂ9"Ê‹ØÁ± %{name_start}%{name}%{name_end} Á∫Ê®Êèê‰æ:",
        },
        coin_price_marquee_widget: {
          powered_by: "Ê≠§ÊSçÂ9"Ê‹ØÁ± %{name_start}%{name}%{name_end} Êèê‰æ:",
        },
        ...
        coin_market_ticker_list_widget: {
          ...
          volume: "‰∫§Ê‹È!è",
          trust_score: "‰ø°‰ªªÂ∆ Ê"∏",
          view_price_chart: "Êx•ÁS9ÂRØÁ}!Ëµ∞Â9¢ÂS",
          powered_by: "Ê≠§ÊSçÂ9"Ê‹ØÁ± %{name_start}%{name}%{name_end} Êèê‰æ:",
          view_all: "View all %{coin} markets",
        },
      };
      ...
      e.exports = {
        ...
        coin_compare_chart_widget: {
          ...
          crypto_market_cap_comparison:
            "Capitalizzazione di mercato delle criptovalute a¬ confronto",
        },
        coin_price_static_headline_widget: {
          powered_by: "Offerto da %{name_start}%{name}%{name_end}",
        },
    ...
    3504: function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "Ê¨ªÂ∏Â¨ºÊ}Âêç",
          mcap: "Â∏Â¨º",
          "24h_volume": "24 Â∞èÊ∂‰∫§Ê‹È!è",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          powered_by: "Á±%{name_start}%{name}%{name_end}Ê}®Â`®",
          crypto_price_comparison: "Â` ÂØ ‰ª∑Ê ºÊØËæí",
          crypto_market_cap_comparison: "Â` ÂØ Â∏Â¨ºÊØËæí",
        },
        coin_price_static_headline_widget: {
          powered_by: "Á±%{name_start}%{name}%{name_end}Ê}®Â`®",
        },
        ...
        beam_widget: { powered_by: "Á±%{name_start}%{name}%{name_end}Ê}®Â`®" },
        coin_ticker_widget: {
          "24h_high": "24Â∞èÊ∂È´‹",
          "24h_low": "24Â∞èÊ∂‰Ω}",
          view_price_chart: "View %{coin} Price Chart",
        ...
        coin_market_ticker_list_widget: {
          ...
          price: "‰ª∑Ê º",
          volume: "‰∫§Ê‹È!è",
          trust_score: "‰ø°Á®ËØÂ∆ ",
          view_price_chart: "ÊµèËß∆‰ª∑Ê ºËµ∞Â`øÂ:æ",
          powered_by: "Á±%{name_start}%{name}%{name_end}Ê}®Â`®",
          view_all: "View all %{coin} markets",
        },
      };
    ...
    "5d67": function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "Posi√ß√£o da capitaliza√ß√£o no mercado",
          mcap: "Capitaliza√ß√£o de mercado",
          "24h_volume": "Volume em 24h",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          powered_by: "Fornecido por %{name_start}%{name}%{name_end}",
          crypto_price_comparison: "Compara√ß√£o de pre√ßo de criptomoedas",
          crypto_market_cap_comparison:
            "Compara√ß√£o de capitaliza√ß√£o de mercado de criptomoedas",
        },
        coin_price_static_headline_widget: {
          powered_by: "Fornecido por %{name_start}%{name}%{name_end}",
        },
        ...
        coin_heatmap_widget: {
          title: "Mapa de √°rvore de criptomoedas",
          subtitle: "(Top %{top} by Market Cap)",
          powered_by: "Fornecido por %{name_start}%{name}%{name_end}",
        },
        random_coin_widget: {
        ...
        coin_market_ticker_list_widget: {
          ...
          price: "Pre√ßo",
          volume: "Volume",
          trust_score: "Pontua√ß√£o de Liquidez",
          view_price_chart: "Ver tabela de pre√ßos",
          powered_by: "Fornecido por %{name_start}%{name}%{name_end}",
          view_all: "View all %{coin} markets",
        },
      };
    ...
    "6ce2": function (e) {
      e.exports = {
        ...
        coin_compare_chart_widget: {
          powered_by: "Pr√§sentiert von %{name_start}%{name}%{name_end}",
          crypto_price_comparison: "Kryptow√§hrungs-Preisvergleich",
          crypto_market_cap_comparison:
            "Vergleich der Kryptow√§hrungs-Marktkapitalisierung",
        },
        coin_price_static_headline_widget: {
          powered_by: "Pr√§sentiert von %{name_start}%{name}%{name_end}",
        },
        ...
        coin_market_ticker_list_widget: {
          ...
          view_price_chart: "Preis√ºbersicht anzeigen",
          powered_by: "Pr√§sentiert von %{name_start}%{name}%{name_end}",
          view_all: "View all %{coin} markets",
        },
      };
    ...
    7704: function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "–x–æ–∑–∏— –∏—è –≤ —¨–µ–π—–∏–Ω–≥–µ Market Cap",
          mcap: "– —9–Ω–æ—!–Ω–∞—è –∫–∞–ø–∏—–∞–ª–∏–∑–∞— –∏—è",
          "24h_volume": "–~–±—`–µ–º –∑–∞ 24¬ —!–∞—Å–∞",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          ...
          crypto_price_comparison:
            "–°—¨–∞–≤–Ω–µ–Ω–∏–µ –∫—í—¨—Å–æ–≤ –∫—¨–∏–ø—–æ–≤–∞–ª—}—",
          crypto_market_cap_comparison:
            "–°—¨–∞–≤–Ω–µ–Ω–∏–µ –∫—¨–∏–ø—–æ–≤–∞–ª—}— –ø–æ —¨—9–Ω–æ—!–Ω–æ–π –∫–∞–ø–∏—–∞–ª–∏–∑–∞— –∏–∏",
        },
        coin_price_static_headline_widget: {
          powered_by: "–~— %{name_start}%{name}%{name_end}",
        },
        ...
        coin_list_widget: { powered_by: "–~— %{name_start}%{name}%{name_end}" },
        beam_widget: { powered_by: "–~— %{name_start}%{name}%{name_end}" },
        coin_ticker_widget: {
          "24h_high": "–S–∞–∫—Å. –∑–∞ 24¬ —!–∞—Å–∞",
          "24h_low": "–S–∏–Ω. –∑–∞ 24¬ —!–∞—Å–∞",
          view_price_chart: "View %{coin} Price Chart",
        ...
        coin_market_ticker_list_widget: {
          ...
          price: "–¶–µ–Ω–∞",
          volume: "–~–±—`–µ–º",
          trust_score: "–x–æ–∫–∞–∑–∞—–µ–ª—R –Ω–∞–¥–µ–∂–Ω–æ—Å—–∏",
          view_price_chart:
            "–x–æ–∫–∞–∑–∞——R –≥—¨–∞—–∏–∫ –∏–∑–º–µ–Ω–µ–Ω–∏—è –∫—í—¨—Å–∞",
          powered_by: "–~— %{name_start}%{name}%{name_end}",
          view_all: "View all %{coin} markets",
        },
      };
    ...
    8680: function (e) {
      e.exports = {
        ...
        coin_compare_chart_widget: {
          powered_by:
            "‡∏‡∏±‡∏a‡π¨‡∏‡∏•‡∏∑‡π∆‡∏≠‡∏"‡∏‡π0‡∏ß‡∏¢ %{name_start}%{name}%{name_end}",
          crypto_price_comparison:
            "‡∏Å‡∏≤‡∏£‡π¨‡∏:‡∏£‡∏µ‡∏¢‡∏a‡π¨‡∏‡∏µ‡∏¢‡∏a‡∏£‡∏≤‡∏‡∏≤ Crypto",
          crypto_market_cap_comparison:
            "‡∏Å‡∏≤‡∏£‡π¨‡∏:‡∏£‡∏µ‡∏¢‡∏a‡π¨‡∏‡∏µ‡∏¢‡∏a‡∏°‡∏π‡∏•‡∏‡π∆‡∏≤‡∏"‡∏≤‡∏°‡∏£‡∏≤‡∏‡∏≤‡∏"‡∏•‡∏≤‡∏‡∏‡∏≠‡∏! Crypto",
        },
        coin_price_static_headline_widget: {
          powered_by:
            "‡∏‡∏±‡∏a‡π¨‡∏‡∏•‡∏∑‡π∆‡∏≠‡∏"‡∏‡π0‡∏ß‡∏¢ %{name_start}%{name}%{name_end}",
        ...
        coin_heatmap_widget: {
          title: "‡πÅ‡∏S‡∏"‡∏‡∏µ‡π∆‡∏£‡∏π‡∏:‡∏"‡π0‡∏"‡π‡∏´‡∏° Cryptocurrency",
          subtitle: "(Top %{top} by Market Cap)",
          powered_by:
            "‡∏‡∏±‡∏a‡π¨‡∏‡∏•‡∏∑‡π∆‡∏≠‡∏"‡∏‡π0‡∏ß‡∏¢ %{name_start}%{name}%{name_end}",
        },
        ...
        coin_market_ticker_list_widget: {
          ...
          price: "‡∏£‡∏≤‡∏‡∏≤",
          volume: "‡∏:‡∏£‡∏¥‡∏°‡∏≤‡∏",
          trust_score: "‡∏‡∏∞‡πÅ‡∏"‡∏"‡∏‡∏ß‡∏≤‡∏°‡π¨‡∏`‡∏∑‡π∆‡∏≠‡∏°‡∏±‡π∆‡∏"",
          view_price_chart: "‡∏‡∏π‡∏Å‡∏£‡∏≤‡∏x‡∏£‡∏≤‡∏‡∏≤",
          powered_by:
            "‡∏‡∏±‡∏a‡π¨‡∏‡∏•‡∏∑‡π∆‡∏≠‡∏"‡∏‡π0‡∏ß‡∏¢ %{name_start}%{name}%{name_end}",
          view_all: "View all %{coin} markets",
        },
    ...
    "89b2": function (e) {
      e.exports = {
        ...
        coin_compare_chart_widget: {
          powered_by: "Tre≈:ƒ! dostarczona przez %{name_start}%{name}%{name_end}",
          crypto_price_comparison: "Por√≥wnanie cen kryptowalut",
          crypto_market_cap_comparison:
            "Por√≥wnanie dominacji w kapitalizacji rynku kryptowalut",
        },
        coin_price_static_headline_widget: {
          powered_by: "Tre≈:ƒ! dostarczona przez %{name_start}%{name}%{name_end}",
        },
        ...
        coin_market_ticker_list_widget: {
          ...
          view_price_chart: "Wy≈:wietl wykres ceny",
          powered_by: "Tre≈:ƒ! dostarczona przez %{name_start}%{name}%{name_end}",
          view_all: "View all %{coin} markets",
        },
      };
    ...
    a306: function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "Clasificaci√≥n de capitalizaci√≥n de mercado",
          mcap: "Cap. de mercado",
          "24h_volume": "Volumen en 24¬ h",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          powered_by: "Con tecnolog√≠a de %{name_start}%{name}%{name_end}",
          crypto_price_comparison: "Comparaci√≥n de precios de criptomonedas",
          crypto_market_cap_comparison:
            "Comparaci√≥n de la capitalizaci√≥n de mercado de las criptomonedas",
        },
        coin_price_static_headline_widget: {
          powered_by: "Con tecnolog√≠a de %{name_start}%{name}%{name_end}",
        },
        coin_price_chart_widget: {
          "24h_high": "M√°ximo en 24 h",
          "24h_low": "M√≠nimo en 24 h",
          view_price_chart: "View %{coin} Price Chart",
          powered_by: "Con tecnolog√≠a de %{name_start}%{name}%{name_end}",
        },
        coin_price_marquee_widget: {
        ...
        coin_heatmap_widget: {
          title: "Mapa de √°rbol de criptomonedas",
          subtitle: "(Top %{top} by Market Cap)",
          powered_by: "Con tecnolog√≠a de %{name_start}%{name}%{name_end}",
        },
        random_coin_widget: {
    ...
    aced: function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "X·∫øp h·∫°ng V·ªn h√≥a th·ª9 tr∆∞·ªùng",
          mcap: "Gi√° tr·ª9 v·ªn h√≥a th·ª9 tr∆∞·ªùng",
          "24h_volume": "Kh·ªi l∆∞·ª£ng trong 24h",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          powered_by: "ƒê∆∞·ª£c h·ª tr·ª£ b·ªxi %{name_start}%{name}%{name_end}",
          crypto_price_comparison: "So s√°nh gi√° ti·ªÅn m√£ h√≥a",
          crypto_market_cap_comparison:
            "So s√°nh v·ªn h√≥a th·ª9 tr∆∞·ªùng ti·ªÅn m√£ h√≥a",
        },
        coin_price_static_headline_widget: {
          powered_by: "ƒê∆∞·ª£c h·ª tr·ª£ b·ªxi %{name_start}%{name}%{name_end}",
        },
        ...
        coin_daily_price_widget: {
          title: "CoinGecko Price Update",
          total_mcap: "Total M cap",
          "24h_vol": "Kh·ªi l∆∞·ª£ng trong 24h",
          dom: "Dom",
        },
        coin_market_ticker_list_widget: {
          exchange: "S√ n giao d·ª9ch",
          pair: "C·∫∑p",
          price: "Gi√°",
          volume: "Kh·ªi l∆∞·ª£ng",
          trust_score: "ƒêi·ªím tin c·∫≠y",
          view_price_chart: "Xem bi·ªíu ƒ·ª gi√°",
          powered_by: "ƒê∆∞·ª£c h·ª tr·ª£ b·ªxi %{name_start}%{name}%{name_end}",
          view_all: "View all %{coin} markets",
        },
      };
    ...
    af08: function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "ÿ™ÿµŸ Ÿ`ŸÅ ÿßŸŸŸ`Ÿ&ÿ© ÿßŸÿ≥Ÿ∆ŸŸ`ÿ©",
          mcap: "ÿßŸŸŸ`Ÿ&ÿ© ÿßŸÿ≥Ÿ∆ŸŸ`ÿ©",
          "24h_volume": "ÿ≠ÿ¨Ÿ& 24 ÿ≥ÿßÿπÿ©",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          powered_by: "ÿ®ÿ±ÿπÿßŸ`ÿ© %{name_start}%{name}%{name_end}",
          crypto_price_comparison:
            "Ÿ&Ÿÿßÿ±Ÿ ÿ© ÿ£ÿ≥ÿπÿßÿ± ÿßŸÿπŸ&Ÿÿ© ÿßŸŸ&ÿ¥ŸÅÿ±ÿ©",
          crypto_market_cap_comparison:
            "Ÿ&Ÿÿßÿ±Ÿ ÿ© ÿ≥ŸŸÅ ÿ£ÿ≥ÿπÿßÿ± ÿ≥Ÿ∆Ÿ ÿßŸÿπŸ&Ÿÿßÿ™ ÿßŸŸ&ÿ¥ŸÅÿ±ÿ©",
        },
        coin_price_static_headline_widget: {
          powered_by: "ÿ®ÿ±ÿπÿßŸ`ÿ© %{name_start}%{name}%{name_end}",
        },
        coin_price_chart_widget: {
          "24h_high": "ÿßÿ±ÿ™ŸÅÿßÿπ ÿπŸŸ0 Ÿ&ÿØÿßÿ± 24 ÿ≥ÿßÿπÿ©",
          "24h_low": "ÿßŸ ÿÆŸÅÿßÿ∂ ÿπŸŸ0 Ÿ&ÿØÿßÿ± 24 ÿ≥ÿßÿπÿ©",
          view_price_chart: "View %{coin} Price Chart",
          powered_by: "ÿ®ÿ±ÿπÿßŸ`ÿ© %{name_start}%{name}%{name_end}",
        },
        coin_price_marquee_widget: {
        ...
        coin_heatmap_widget: {
          title: "ÿÆÿ±Ÿ`ÿ∑ÿ© ÿ¥ÿ¨ÿ±ÿ© ÿßŸÿπŸ&Ÿÿßÿ™ ÿßŸŸ&ÿ¥ŸÅÿ±ÿ©",
          subtitle: "(Top %{top} by Market Cap)",
          powered_by: "ÿ®ÿ±ÿπÿßŸ`ÿ© %{name_start}%{name}%{name_end}",
        },
        random_coin_widget: {
        ...
        coin_market_ticker_list_widget: {
          ...
          pair: "ÿ≤Ÿ∆ÿ¨",
          price: "ÿßŸÿ≥ÿπÿ±",
          volume: "ÿ≠ÿ¨Ÿ& ÿßŸÿ™ÿØÿßŸ∆Ÿ",
          trust_score: "Ÿ ÿ™Ÿ`ÿ¨ÿ© ÿßŸŸ&Ÿ∆ÿ´Ÿ∆ŸŸ`ÿ©",
          view_price_chart: "ÿπÿ±ÿ∂ Ÿ&ÿÆÿ∑ÿ∑ ÿßŸÿ≥ÿπÿ±",
          powered_by: "ÿ®ÿ±ÿπÿßŸ`ÿ© %{name_start}%{name}%{name_end}",
          view_all: "View all %{coin} markets",
        },
      };
    ...
    dd11: function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "Ï9SÍ∞¨Ï¥ùÏ"° Ï∆SÏS",
          mcap: "Ï9SÍ∞¨Ï¥ùÏ"°",
          "24h_volume": "24Ï9SÍ∞ Í±∞Î~‹Îx0",
          "24h_high_low": "24H High/Low",
        },
        coin_compare_chart_widget: {
          powered_by: "Powered by %{name_start}%{name}%{name_end}",
          crypto_price_comparison: "Ï"Ì‹∏Ì"Ìèê Í∞¨Í≤© ÎπÍµê",
          crypto_market_cap_comparison: "Ï"Ì‹∏Ì"Ìèê Ï9SÍ∞¨Ï¥ùÏ"° ÎπÍµê",
        },
        coin_price_static_headline_widget: {
          powered_by: "Powered by %{name_start}%{name}%{name_end}",
        },
        ...
        coin_market_ticker_list_widget: {
          ...
          price: "Ï9SÏ∏",
          volume: "Í±∞Î~‹ÎR¨Í∏∆",
          trust_score: "Ï9 Î¢∞Ïß¨Ï∆‹",
          view_price_chart: "Ï∞®Ì`∏ Î≥¥Í∏∞",
          powered_by: "Powered by %{name_start}%{name}%{name_end}",
          view_all: "View all %{coin} markets",
        },
      };
    ...
    f693: function (e) {
      e.exports = {
        ...
        coin_compare_chart_widget: {
          ...
          crypto_market_cap_comparison:
            "Comparaison des capitalisations de march√© de crypto",
        },
        coin_price_static_headline_widget: {
          powered_by: "Fourni par %{name_start}%{name}%{name_end}",
        },
        ...
        random_coin_widget: {
          disclaimer:
            "Clause de non responsabilit√© : Cet outil ne sert qu'√  des fins de divertissement et ne constitue pas de conseils financiers",
          spin: "Tourner",
    ...
    ffeb: function (e) {
      e.exports = {
        coin_details: {
          mcap_rank: "Piyasa Deƒxeri Sƒ±ralamasƒ±",
          mcap: "Piyasa Deƒxeri",
        ...
        coin_compare_chart_widget: {
          powered_by:
            "%{name_start}%{name}%{name_end} tarafƒ±ndan desteklenmektedir",
          crypto_price_comparison: "Kripto Fiyat Kar≈xƒ±la≈xtƒ±rmasƒ±",
          crypto_market_cap_comparison:
            "Kripto Piyasa Deƒxeri Kar≈xƒ±la≈xtƒ±rmasƒ±",
        },
        coin_price_static_headline_widget: {
          powered_by:
            "%{name_start}%{name}%{name_end} tarafƒ±ndan desteklenmektedir",
        ...
        coin_price_chart_widget: {
          "24h_high": "24S Y√ºksek",
          "24h_low": "24S D√º≈x√ºk",
          view_price_chart: "View %{coin} Price Chart",
          powered_by:
            "%{name_start}%{name}%{name_end} tarafƒ±ndan desteklenmektedir",
        },
        ...
        coin_heatmap_widget: {
          title: "Kripto Para Aƒxacƒ± Haritasƒ±",
          subtitle: "(Top %{top} by Market Cap)",
          powered_by:
            "%{name_start}%{name}%{name_end} tarafƒ±ndan desteklenmektedir",
        },
        ...
        coin_market_ticker_list_widget: {
          ...
          price: "Fiyat",
          volume: "Hacim",
          trust_score: "G√ºven Puanƒ±",
          view_price_chart: "Fiyat Tablosunu G√∂r",
          powered_by:
            "%{name_start}%{name}%{name_end} tarafƒ±ndan desteklenmektedir",
          view_all: "View all %{coin} markets",
        },
